...
class PopularProductListController
    extends BasePaginationController<ProductModel, ProductQueryModel> {
  final ProductListUseCase _productListUseCase;

  PopularProductListController({required ProductListUseCase productListUseCase})
  ...
  Future<void> loadInitialData() async {
    await loadInitial(query: ProductQueryModel(tag: "popular"));
  }
}
